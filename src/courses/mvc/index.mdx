---
title: "Updating MVC apps to ASP.NET 6/7"
date: "2022-02-26"
slug: "AspNet6"
---
...
ASP.NET 6 is replacing the MVC platform from the old .NET Framework 4. It is a major new platform built from .NET Core.
